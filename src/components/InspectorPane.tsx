    ...
    <div className="w-full h-full flex flex-col bg-white overflow-hidden">
      ...
      {activeTab === 'assist' ? (
        <div className="flex-1 overflow-y-auto bg-slate-50/50 flex flex-col">
          ...
          {/* Evidence Summary */}
          <div className="p-4">
            <h3 className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2">Evidence Summary</h3>
            <div className="space-y-1.5">
              <div className="px-2.5 py-1.5 bg-white border border-slate-200 rounded-md shadow-sm flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <BookOpen className="w-3 h-3 text-primary-500" />
                  <span className="text-[11px] font-medium text-slate-700">Terms</span>
                </div>
                <span className="text-[10px] font-semibold text-primary-600 bg-primary-50 px-1.5 py-0.5 rounded">2 matched</span>
              </div>
              <div className="px-2.5 py-1.5 bg-white border border-slate-200 rounded-md shadow-sm flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <RefreshCw className="w-3 h-3 text-emerald-500" />
                  <span className="text-[11px] font-medium text-slate-700">Similar</span>
                </div>
                <span className="text-[10px] font-semibold text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded">1 high-similarity</span>
              </div>
            </div>
          </div>
        </div>
